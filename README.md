...
- [ ] Explain what a token is used for.
  ...
  A token is used to give a user authorization to reach certain areas of a website.

- [ ] What steps can you take in your web apps to keep your data secure?

  Use tokens and protected routes to require autorization when accessing certain data.

- [ ] Describe how web servers work.

  Web servers contain all the files of a web page and remotely 'serve' them to 'clients' which are web browsers.
